...
public class WxUtil {
    ...
    public static String getAccessToken(String appId, String appSecret) {
        Map<String, String> accessTokenInfo = accessTokenInfoMap.get(appId);
        ...
        try {
            String ret = restTemplate.getForObject(newUrl, String.class);
            if (null != ret) {
                ...
                if (maps.containsKey("access_token")) {
                    ...
                    accessTokenInfoMap.put(appId, accessTokenInfo);
    ...
    public static String getJsapiTicket(String appId, String appSecret) {
        Map<String, String> jsapiTicketInfo = jsapiTicketInfoMap.get(appId);
        ...
        try {
            ...
            if (null != ret) {
                ...
                if (null != maps && maps.containsKey("ticket")) {
                    ...
                    jsapiTicketInfoMap.put(appId, jsapiTicketInfo);
